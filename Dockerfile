...
RUN wget https://www.apachefriends.org/xampp-files/7.4.1/xampp-linux-x64-7.4.1-0-installer.run
RUN chmod +x xampp-linux-x64-7.4.1-0-installer.run
RUN ./xampp-linux-x64-7.4.1-0-installer.run
RUN rm xampp-linux-x64-7.4.1-0-installer.run
